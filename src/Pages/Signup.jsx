...
function Signup() {
  ...
  return (
    ...
    <div className='bg-slate-700' style={{height:"100vh"}}>
      ...
      <div className='border bg-white p-8 my-8 rounded-lg'>

        <h1 className='text-3xl text-center font-semibold my-6'>Sign Up</h1>
        <form onSubmit={handleSubmit} className='flex flex-col gap-4 '>
          <input  type='text'placeholder='username' className='border border-blue-800 p-3 rounded-lg'id='username'onChange={handleChange} />
